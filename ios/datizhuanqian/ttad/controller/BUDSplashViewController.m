...
- (void)buildupDefaultSplashView {
  ...
  BUSplashAdView *splashView = [[BUSplashAdView alloc] initWithSlotID:self.slotID frame:self.splashFrame];
...
- (void)buildupHideSkipButtonSplashView {
  ...
  BUSplashAdView *splashView = [[BUSplashAdView alloc] initWithSlotID:self.slotID frame:frame];
...
- (void)splashAdDidCloseOtherController:(BUSplashAdView *)splashAd interactionType:interactionType {
  NSString *str = @"";
