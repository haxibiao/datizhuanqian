...
const render = {
    question: color => (
        <View style={styles.placeholder}>
            ...
            <View style={[styles.answer, { width: Percent(70), backgroundColor: color }]} />
            <View style={[styles.answer, { width: Percent(50), backgroundColor: color }]} />
            <View style={[styles.answer, { width: Percent(60), backgroundColor: color }]} />
            <View style={[styles.answer, { width: Percent(80), backgroundColor: color }]} />
        </View>
    ),
    comment: color => (
