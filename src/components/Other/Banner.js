...
class Banner extends Component {
    ...
    render() {
        const { data, backgroundColor, textColor } = this.props;
        ...
        return (
            <View style={[styles.container, { backgroundColor: backgroundColor || Theme.white }]}>
                ...
                <View style={styles.rowItem}>
                    ...
                    <Text
                        style={{
                            fontSize: Font(15),
                            color: user.ticket > 10 ? textColor || Theme.black : Theme.themeRed,
                        }}>
            ...
            <Overlay.View animated>
                <View style={styles.overlay}>
                    <View
                        ...
                        <Image
                            source={require('@src/assets/images/ic_answered_error.png')}
