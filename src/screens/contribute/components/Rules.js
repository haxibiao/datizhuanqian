...
import { Button, TouchFeedback, Iconfont } from '../../../components';
				...
				<ScrollView showsVerticalScrollIndicator={false}>
					...
					<View style={{ marginTop: PxFit(5) }}>
						...
						>
							...
							同时请各位答友出题尽量做到
							<Text style={{ color: Theme.themeRed }}>格式规范、分类准确、描述清晰、解答详细</Text>。
							内容请注重原创性、具备知识分享的意义。
						</Text>

						<Text style={{ fontSize: PxFit(13), color: Theme.black, paddingVertical: 5 }}>
							您的题目不得含有下列内容的信息：
						</Text>
						<View>
							<Text style={styles.title}>1.题目无实际意义/无教学意义/过于小众/题干或答案错误。</Text>
						...
						<View>
							<Text style={styles.title}>3.题干图片模糊、带有答案、图文不符、含有二维码。</Text>
							<Image
