/*
 * @flow
 * created by wyk made in 2019-03-21 14:11:31
 */
'use strict';
...
const styles = StyleSheet.create({
	...
	titleText: { color: Theme.defaultTextColor, fontSize: PxFit(16) },
	sectionTitleText: { color: Theme.defaultTextColor, fontSize: PxFit(15), paddingVertical: PxFit(10) },
	lineHeight: {
		color: '#969696',
		lineHeight: PxFit(18)
	}
