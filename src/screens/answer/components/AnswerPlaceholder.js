            ...
            <Animated.View style={[styles.placeholder, style]}>
                <View>
                    ...
                    <View style={{ padding: PxFit(Theme.itemSpace) }}>
                        ...
                        <View style={[styles.answer, { width: Percent(70) }]} />
                        <View style={[styles.answer, { width: Percent(50) }]} />
                        <View style={[styles.answer, { width: Percent(60) }]} />
                        <View style={[styles.answer, { width: Percent(80) }]} />
                    </View>
                </View>
