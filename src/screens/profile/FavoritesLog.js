...
import { PageContainer, Iconfont, TouchFeedback, CustomRefreshControl, ListFooter, PlaceholderImage } from 'components';
        ...
        return (
            <Query query={GQL.FavoritesQuery} fetchPolicy="network-only">
                {({ data, loading, refetch, fetchMore }) => {
                    let favorites = Helper.syncGetter('favorites', data);
                ...
                <TouchableWithoutFeedback onPress={() => navigation.navigate('Question', { question })}>
                    <View style={styles.questionItem}>
                        <View style={styles.questionCategory}>
                            ...
                            <Text style={styles.metaText}>{Helper.count(count) + '人答过'}</Text>
                        </View>
