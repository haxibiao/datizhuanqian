...
const ScrollableTabBar = createReactClass({
    propTypes: {
        ...
        // activeTextStyle: PropTypes.style,
        // inactiveTextStyle: PropTypes.style,
    ...
    renderTab(name, page, isTabActive, onPressHandler, onLayoutHandler) {
        const { activeTextStyle, inactiveTextStyle, textStyle } = this.props;
        const toggleStyle = isTabActive ? activeTextStyle : inactiveTextStyle;
        const style = {
            ...textStyle,
            ...toggleStyle,
        };
