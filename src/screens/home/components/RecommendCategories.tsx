...
const RecommendCategories = () => {
    ...
    const RecommendCategoriesQuery = useCallback(() => {
        return client.query({
            query: GQL.RecommendCategoriesQuery,
    ...
    const getData = useCallback(async () => {
        const recommendCategoriesQuery = await Helper.exceptionCapture(() => RecommendCategoriesQuery());
        const recommendCategories = Helper.syncGetter('data.recommendCategories', recommendCategoriesQuery[1]) || [];
        setCategories(recommendCategories);
        count.current += recommendCategories.length;
    }, [RecommendCategoriesQuery]);
