...
class OptionItem extends Component {
    ...
    onPress = () => {
        let { option, selectOption } = this.props;
        selectOption(option.Value);
    };

    buildProps = () => {
        let { selectedOption, option, correct } = this.props;
        ...
        return (
            <Animated.View style={animateStyles}>
                <View style={styles.optionItemWrap}>
                    <TouchFeedback style={styles.optionItem} onPress={this.onPress}>
