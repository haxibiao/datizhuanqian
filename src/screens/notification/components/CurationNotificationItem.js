...
class CurationNotificationItem extends Component {
    ...
    render() {
        ...
        let type = Helper.syncGetter('curation.type', notification);
        return (
            <View style={styles.item}>
                ...
                <View style={styles.bottomInfo}>
                    ...
                    <Text style={styles.infoItem}>
                        奖励：{`${Helper.syncGetter('curation.gold_awarded', notification)}智慧点`}{' '}
                    </Text>
                    ...
                    <Text style={styles.infoItem}>时间：{Helper.syncGetter('curation.created_at', notification)}</Text>
                    <Text style={[styles.infoItem, { lineHeight: 22 }]}>
                        题目名：{Helper.syncGetter('curation.question.description', notification)}
                    </Text>
                </View>
            </View>
        );
