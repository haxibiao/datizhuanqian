            ...
            <View style={styles.item}>
                ...
                <View style={styles.bottomInfo}>
                    ...
                    <Text style={styles.infoItem}>
                        专题：{Helper.syncGetter('question.category.name', notification)}{' '}
                    </Text>
                    <Text style={styles.infoItem}>时间：{Helper.syncGetter('question.created_at', notification)}</Text>
                    <Text style={[styles.infoItem, { lineHeight: 20 }]}>
                        题目名：{Helper.syncGetter('question.description', notification)}
                    </Text>
                </View>
            </View>
        );
